...
var _ = Lodash._;
var Parallel = require("../bower_components/paralleljs/lib/parallel.js");
...
var calculate = function (options, attributes, value, difficulty) {
    ...
    var parallel = new Parallel(COMBINATIONS, { evalPath: 'benchmarks/eval.js' });
    var outcomes = parallel.require("bower_components/lodash/dist/lodash.js").map(evaluator);
