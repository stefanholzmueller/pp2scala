...
public class CheckResultCalculatorTest {
	...
	public void shouldReturnResult() throws Exception {
		OutcomeImpl result = calculator.examine(trivialCheck, ALL_THREES);
	...
	public void shouldReturnSpectacularSuccess() throws Exception {
		OutcomeImpl result = calculator.examine(trivialCheck, new IntTriple(1,
				1, 1));
	...
	public void shouldReturnLuckySuccess() throws Exception {
		...
		assertThat(result.getOutcome(), is(OutcomeEnum.AUTOMATIC_SUCCESS));
	}

	@Test
	public void shouldReturnFumble() throws Exception {
		OutcomeImpl result = calculator.examine(trivialCheck, new IntTriple(20,
				1, 20));

		assertThat(result.getOutcome(), is(OutcomeEnum.AUTOMATIC_FAILURE));
	}
	...
	public void shouldReturnSpectacularFumble() throws Exception {
		...
		assertThat(result.getOutcome(), is(OutcomeEnum.SPECTACULAR_FAILURE));
	}

	@Test
	public void shouldReturnUnsuccessful() throws Exception {
		OutcomeImpl result = calculator.examine(trivialCheck, new IntTriple(18,
				18, 18));

		assertThat(result.getOutcome(), is(OutcomeEnum.FAILURE));
	}
	...
	public void shouldReturnSuccessful() throws Exception {
		...
		assertThat(result.getOutcome(), is(OutcomeEnum.SUCCESS));
	}

	@Test
	public void shouldNotReturnFumbleForTollpatschCheck() throws Exception {
		trivialCheck.setTollpatsch(true);
		OutcomeImpl result = calculator.examine(trivialCheck, new IntTriple(19,
				11, 18));

		assertThat(result.getOutcome(), is(not(OutcomeEnum.AUTOMATIC_FAILURE)));
	}
	...
	public void shouldReturnSpruchhemmung() throws Exception {
		...
		OutcomeImpl result = calculator.examine(trivialCheck, new IntTriple(14,
				14, 3));
	...
	public void shouldReturnNegativePossibleDifficulty() throws Exception {
		OutcomeImpl result = calculator.examine(trivialCheck, new IntTriple(16,
				16, 16));
	...
	public void shouldReturnQualityExcludingDifficulty() throws Exception {
		OutcomeImpl result = calculator.examine(new Check(12, 12, 12, 7, 4),
				ALL_THREES);
	...
	public void shouldNotCountNegativeDifficultyAsQuality() throws Exception {
		OutcomeImpl result = calculator.examine(new Check(12, 12, 12, -3, -7),
				ALL_THREES);
	...
	public void shouldReturnFullValueAsQuality() throws Exception {
		OutcomeImpl result = calculator.examine(new Check(12, 12, 12, 7),
				new IntTriple(1, 1, 19));
	...
	public void shouldReturnMinimumEffectAsQuality() throws Exception {
		Check check = new Check(12, 12, 12, 0);
		check.setMinimumQuality(true);
		OutcomeImpl result = calculator.examine(check, new IntTriple(1, 1, 1));
	...
	public void shouldReturnMinimumEffectIfValueIsUsedUp() throws Exception {
		...
		OutcomeImpl result = calculator.examine(check,
				new IntTriple(13, 13, 13));
	...
	public void shouldCountFailedPointsWithNegativeValue() throws Exception {
		OutcomeImpl result = calculator.examine(new Check(12, 12, 12, -3),
				new IntTriple(10, 12, 11));
	...
	public void shouldCountFailedPointsWithPositiveValue() throws Exception {
		OutcomeImpl result = calculator.examine(trivialCheck, new IntTriple(10,
				12, 20));
	...
	public void shouldReturnPossibleDifficultyIfDifficultyUsesUpAllPoints()
			throws Exception {
		OutcomeImpl result = calculator.examine(new Check(12, 12, 12, 3, 5),
				new IntTriple(9, 8, 6));
