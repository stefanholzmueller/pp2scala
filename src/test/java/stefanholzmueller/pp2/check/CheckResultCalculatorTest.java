...
public class CheckResultCalculatorTest {
    ...
    public void shouldReturnSpectacularSuccess() throws Exception {
        CheckResult result = decider.calculateResult(trivialCheck, new IntTriple(1, 1, 1));
    ...
    public void shouldReturnLuckySuccess() throws Exception {
        CheckResult result = decider.calculateResult(trivialCheck, new IntTriple(1, 1, 17));
    ...
    public void shouldReturnFumble() throws Exception {
        CheckResult result = decider.calculateResult(trivialCheck, new IntTriple(20, 1, 20));
    ...
    public void shouldReturnSpectacularFumble() throws Exception {
        CheckResult result = decider.calculateResult(trivialCheck, new IntTriple(20, 20, 20));
    ...
    public void shouldReturnUnsuccessful() throws Exception {
        CheckResult result = decider.calculateResult(trivialCheck, new IntTriple(18, 18, 18));
    ...
    public void shouldNotReturnFumbleForTollpatschCheck() throws Exception {
        ...
        CheckResult result = decider.calculateResult(trivialCheck, new IntTriple(19, 11, 18));
    ...
    public void shouldReturnFumbleForTollpatschCheck() throws Exception {
        trivialCheck.setTollpatsch(true);
        CheckResult result = decider.calculateResult(trivialCheck, new IntTriple(19, 11, 20));
    ...
    public void shouldNotReturnFumbleForFesteMatrixCheck() throws Exception {
        ...
        CheckResult result = decider.calculateResult(trivialCheck, new IntTriple(20, 17, 20));
    ...
    public void shouldReturnFumbleForFesteMatrixCheck() throws Exception {
        trivialCheck.setFesteMatrix(true);
        CheckResult result = decider.calculateResult(trivialCheck, new IntTriple(20, 18, 20));
    ...
    public void shouldReturnSpruchhemmung() throws Exception {
        ...
        CheckResult result = decider.calculateResult(trivialCheck, new IntTriple(14, 14, 3));
    ...
    public void shouldReturnNegativePossibleDifficulty() throws Exception {
        CheckResult result = decider.calculateResult(trivialCheck, new IntTriple(16, 16, 16));
    ...
    public void shouldReturnQualityExcludingDifficulty() throws Exception {
        CheckResult result = decider.calculateResult(new Check(12, 12, 12, 7, 4), ALL_THREES);
    ...
    public void shouldNotCountNegativeDifficultyAsQuality() throws Exception {
        CheckResult result = decider.calculateResult(new Check(12, 12, 12, -3, -7), ALL_THREES);
    ...
    public void shouldCountZeroValueAsMinimumEffect() throws Exception {
        ...
        CheckResult result = decider.calculateResult(check, ALL_THREES);
    ...
    public void shouldReturnFullValueAsQuality() throws Exception {
        CheckResult result = decider.calculateResult(new Check(12, 12, 12, 7), new IntTriple(1, 1, 19));
    ...
    public void shouldReturnMinimumEffectAsQuality() throws Exception {
        Check check = new Check(12, 12, 12, 0);
        check.setMinimumQuality(true);
        CheckResult result = decider.calculateResult(check, new IntTriple(1, 1, 1));
    ...
    public void shouldReturnMinimumEffectIfValueIsUsedUp() throws Exception {
        ...
        CheckResult result = decider.calculateResult(check, new IntTriple(13, 13, 13));
    ...
    public void shouldCountFailedPointsWithNegativeValue() throws Exception {
        CheckResult result = decider.calculateResult(new Check(12, 12, 12, -3), new IntTriple(10, 12, 11));
    ...
    public void shouldCountFailedPointsWithPositiveValue() throws Exception {
        CheckResult result = decider.calculateResult(trivialCheck, new IntTriple(10, 12, 20));
    ...
    public void shouldReturnPossibleDifficultyIfPointsArePositive() throws Exception {
        CheckResult result = decider.calculateResult(trivialCheck, new IntTriple(10, 8, 6));
    ...
    public void shouldReturnPossibleDifficultyIfDifficultyUsesUpAllPoints() throws Exception {
        CheckResult result = decider.calculateResult(new Check(12, 12, 12, 3, 5), new IntTriple(9, 8, 6));
    ...
    public void shouldReturnPossibleDifficultyIfNegativeDifficultyGrantsPoints() throws Exception {
        CheckResult result = decider.calculateResult(new Check(12, 12, 12, -3, -7), new IntTriple(10, 8, 6));
    ...
    public void shouldReturnPossibleDifficultyIfPointsAreNegative() throws Exception {
        CheckResult result = decider.calculateResult(new Check(12, 12, 12, -3), new IntTriple(1, 2, 3));
